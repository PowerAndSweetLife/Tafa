...
class Database
{
	...
	public function customSelect($requete, $option = false)
	{
	...
	public function leftJoinOnId($table1, $table2, $column)
	{
		$table1 = htmlspecialchars(trim($table1));
		$table2 = htmlspecialchars(trim($table2));
		$column = htmlspecialchars(trim($column));

		$this->query .= " LEFT JOIN " . $table2 . " ON " . $table1 . "." . $column . " = " . $table2 . "." . $column;
...
// Database::init("localhost","sucoma","3306","root","sucomainfo2021");
//	Database::init("localhost","sucoma","3306","root","");



Database::init("localhost", "hafa", "", "root", "");
