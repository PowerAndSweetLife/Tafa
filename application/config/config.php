...
|
*/
$config['base_url'] = 'http://localhost/Tafa+Api/';
...
// Définir la taille maximale de téléchargement (upload_max_filesize) en octets
ini_set('upload_max_filesize', '100M'); // Par exemple, pour autoriser jusqu'à 100 Mo

// Définir la taille maximale des données POST (post_max_size) en octets
ini_set('post_max_size', '100M'); // Par exemple, pour autoriser jusqu'à 100 Mo
